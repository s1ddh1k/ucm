...
async function generateNextQuestion(sessionId) {
  ...
  const hasValidArea = typeof parsed.area === "string"
    && Object.prototype.hasOwnProperty.call(session.expectedAreas || {}, parsed.area);
...
async function startRefinement(params = {}) {
  ...
  const rawDescription = description ?? body ?? "";
